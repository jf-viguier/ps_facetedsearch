...
Mécanique complète du module, et les trois autres customisations qu'il porte : [crea_facetedsearchcustomisations/README.md](../../crea_facetedsearchcustomisations/README.md).
